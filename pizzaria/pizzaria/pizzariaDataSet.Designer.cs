...
namespace pizzaria {
    ...
    public partial class pizzariaDataSet : global::System.Data.DataSet {
        ...
        public partial class pedidoDataTable : global::System.Data.TypedTableBase<pedidoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public pedidoRow AddpedidoRow(string nome, string endereco, string pedido, string telefone, string observacao, float preco) {
        ...
        public partial class pedidoRow : global::System.Data.DataRow {
            ...
            public string nome {
                get {
                    return ((string)(this[this.tablepedido.nomeColumn]));
                }
                set {
                    this[this.tablepedido.nomeColumn] = value;
                }
            }
            ...
            public float preco {
                get {
                    return ((float)(this[this.tablepedido.precoColumn]));
                }
                set {
                    this[this.tablepedido.precoColumn] = value;
                }
            }
        }
...
namespace pizzaria.pizzariaDataSetTableAdapters {
    ...
    public partial class pedidoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[pedido] WHERE (([id] = @Original_id) AND ([nome] = @Original_nome) AND ([endereco] = @Original_endereco) AND ([pedido] = @Original_pedido) AND ([telefone] = @Original_telefone) AND ([observacao] = @Original_observacao) AND ([preco] = @Original_preco))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[pedido] ([nome], [endereco], [pedido], [telefone], [observacao], [preco]) VALUES (@nome, @endereco, @pedido, @telefone, @observacao, @preco);
SELECT id, nome, endereco, pedido, telefone, observacao, preco FROM pedido WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[pedido] SET [nome] = @nome, [endereco] = @endereco, [pedido] = @pedido, [telefone] = @telefone, [observacao] = @observacao, [preco] = @preco WHERE (([id] = @Original_id) AND ([nome] = @Original_nome) AND ([endereco] = @Original_endereco) AND ([pedido] = @Original_pedido) AND ([telefone] = @Original_telefone) AND ([observacao] = @Original_observacao) AND ([preco] = @Original_preco));
SELECT id, nome, endereco, pedido, telefone, observacao, preco FROM pedido WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, nome, endereco, pedido, telefone, observacao, preco FROM dbo.pedido";
        ...
        public virtual int Delete(int Original_id, string Original_nome, string Original_endereco, string Original_pedido, string Original_telefone, string Original_observacao, float Original_preco) {
        ...
        public virtual int Insert(string nome, string endereco, string pedido, string telefone, string observacao, float preco) {
            if ((nome == null)) {
        ...
        public virtual int Update(string nome, string endereco, string pedido, string telefone, string observacao, float preco, int Original_id, string Original_nome, string Original_endereco, string Original_pedido, string Original_telefone, string Original_observacao, float Original_preco, int id) {
            if ((nome == null)) {
                throw new global::System.ArgumentNullException("nome");
            }
            else {
            ...
            if ((Original_pedido == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((string)(Original_pedido));
            }
            if ((Original_telefone == null)) {
                throw new global::System.ArgumentNullException("Original_telefone");
            }
            ...
            this.Adapter.UpdateCommand.Parameters[12].Value = ((float)(Original_preco));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nome, string endereco, string pedido, string telefone, string observacao, float preco, int Original_id, string Original_nome, string Original_endereco, string Original_pedido, string Original_telefone, string Original_observacao, float Original_preco) {
            return this.Update(nome, endereco, pedido, telefone, observacao, preco, Original_id, Original_nome, Original_endereco, Original_pedido, Original_telefone, Original_observacao, Original_preco, Original_id);
        }
    }
